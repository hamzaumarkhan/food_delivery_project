			...
			<div class="top-cate">
				<div class="featured-pro container">
					<form id="deliveryForm">
						<h2>ORDER NOW</h2>
						<ul id="trans_button">
							<h5>Please enter your desired transaction first so we can display the right information such as product prices and availability.</h5>
							<li>
									...
									<div class="page-not-found img">
										<a id="btnDelivery" name="btnDelivery" title="Delivery"
											...
											<img class="page-not-found img"
												src="http://localhost/food_delivery/images/img-1.png" alt="blog image">
								...
								<div class="pro-coloumn">
									<div class="block">
										<article class="col-main">
											...
											<?php 
										$sql="SELECT id, title,price,description FROM product ";
										$run=mysqli_query($conn,$sql);
										while ($row=mysqli_fetch_assoc($run)) {
										echo '
												<ul class="products_content-grid col-lg-3" id="product_ul_379">
													<div class= "products_cover">
														<div class="products_img-cover">
															<img src="images/pork sisig.jpg">
														</div>
													</div>
													<div class="total_content-cover">
														<div class="total_content">
															...
															<h3 class="my_total">'.$row['price'].'</h3>
														</div>
														<div class="input-box1 my_order" id="billing-buttons-container">
															<button type="button" title="Proceed" class="button continue swalWait" onclick="run_modal();"
															onclick="add_cart('.$row['id'].');"	id="btnProceed"><span>order now</span></button>
														</div>
													</div>
												</ul>';
											}
												...
												<ul class="products_content-grid col-lg-3" id="product_ul_379">
													...
													<div class="total_content-cover">
														<div class="total_content">
															...
															<h3 class="my_total">Total Price : Php.160 </h3>
														</div>
														<div class="input-box1 my_order" id="billing-buttons-container">
															<button type="button" title="Proceed" class="button continue swalWait" onclick="run_modal();"
																id="btnProceed"><span>order now</span>
															</button>
														</div>
													</div>
												</ul>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <form id="deliveryForm">
			<h2 class="modal_text">ORDER NOW</h2>
			<ul id="trans_button">
				<h5 class="modal_text">Please enter your desired transaction first so we can display the right information such as product prices and availability.</h5>
					<div class="blog-img modal-img1 col-sm-6 col-xs-6">
						<div class="page-not-found img">
							<a id="btnDelivery" name="btnDelivery" title="Delivery"
								href="delivery.php" class="swalWait">
								<img class="page-not-found img"
									src="images/img-1.png" alt="blog image">
							</a>
						</div>
					</div>
					<div class="blog-img modal-img2 col-sm-6 col-xs-6">
							<a id="btnPickup" name="btnPickup" title="Pickup"
								href="pickup.php" class="swalWai">
								<img class="page-not-found img"
									src="images/img-2.jpg" alt="blog image">
							</a>
						</div>
					</div>
				</ul>
