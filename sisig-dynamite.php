									...
									<div class="page-not-found img">
										<a id="btnDelivery" name="btnDelivery" title="Delivery"
											...
											<img class="page-not-found img"
												src="http://localhost/food-delivery/images/img-1.jpg" alt="blog image">
											<h4>Delivery</h4>
										</a>
									</div>
								</div>
								...
								<div class="blog-img col-sm-6 col-xs-6">
									<div class="page-not-found img">
										<a id="btnPickup" name="btnPickup" title="Pickup"
											...
											<img class="page-not-found img"
												src="http://localhost/food-delivery/images/img-2.jpg" alt="blog image">
											<h4>Pickup</h4>
										</a>
									</div>
								</div>
												...
												<ul class="products_content-grid col-lg-3" id="product_ul_379">
													<div class= "products_cover">
														<div class="products_img-cover">
															<img src="images/sisig dynamite.jpg">
														</div>
													</div>
													<div class="total_content-cover">
														<div class="total_content">
															...
															<h3 class="my_total">Total Price : Php. 130</h3>
														</div>
														<div class="input-box1 my_order" id="billing-buttons-container">
															<button type="button" title="Proceed" class="button continue swalWait"
																id="btnProceed"><span>order now</span></button>
														</div>
													</div>
												</ul>
											</div>
