	...
	<div class="offcanvas-content pr-5 mr-n5">
		...
		<div class="d-flex align-items-center mt-5">
			<div class="symbol symbol-100 mr-5">
				<div class="symbol-label" style="background-image:url('../assets/images/user.jpg')"></div>
			</div>
		...
		<div class="topbar-item p-4 text-center">
				<a href="http://localhost/food_delivery/includes/login/logout.php" class="btn bg-gray-200 bg-hover-primary border border-secondary"> <i class="fas fa-sign-out-alt"></i> Sign Out</a>
		</div>
		<!--end::Nav-->
		<!--begin::Separator-->
